...
export default function TeacherLayout({ children, title = 'Teacher Dashboard' }) {
 ...
 <div className="w-32 h-32 rounded-full bg-bg-card border-2 border-primary-light-hover shadow-lg flex items-center justify-center p-2 overflow-hidden mb-4">
