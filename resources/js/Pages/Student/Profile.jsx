    ...
    return (
        <StudentLayout title="My Profile">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors">
                    ...
                    <form onSubmit={handleUpdateProfile} className="p-6 sm:p-8 space-y-6">
                        <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 pb-8 border-b border-slate-100 dark:border-slate-700">
                            <div className="w-24 h-24 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-blue-700 dark:text-blue-400 text-3xl font-bold border-4 border-white dark:border-slate-800 shadow-sm">
                                {profile.name ? profile.name.charAt(0).toUpperCase() : '?'}
                            </div>
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white">{profile.name || 'Student'}</h3>
                                <p className="text-slate-500 dark:text-slate-400">Student Account</p>
                            </div>
                        </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors">
                    <div className="p-6 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 flex items-center">
                        <KeyRound className="w-5 h-5 mr-3 text-red-600 dark:text-red-400" />
                        <h2 className="text-xl font-bold text-slate-800 dark:text-white">Security & Password</h2>
                    </div>
