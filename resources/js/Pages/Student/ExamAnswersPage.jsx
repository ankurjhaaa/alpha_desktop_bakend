...
export default function ExamAnswersPage({ paperId }) {
    ...
    return (
        <StudentLayout title="Detailed Answers">
            ...
            <div className="mb-6">
                <Link href={`/student/exams/${paperId}/result`} className="inline-flex items-center text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                {isLoading ? (
                    <div className="flex justify-center items-center py-24 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700">
                                ...
                                <div className="p-6">
                                    ...
                                    {q.explanation && (
                                        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 rounded-xl">
                                            <h4 className="font-bold text-blue-900 dark:text-blue-300 mb-1">Explanation:</h4>
