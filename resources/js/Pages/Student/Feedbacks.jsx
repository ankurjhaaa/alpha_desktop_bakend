            ...
            <div className="max-w-2xl mx-auto mt-8">
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white text-center">
                        ...
                        <p className="text-blue-100">Let us know if you have any issues, suggestions, or questions for your teachers.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-900 dark:text-white min-h-[150px]"
