    ...
    return (
        <StudentLayout title="Leaderboard">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl p-8 mb-8 text-white shadow-lg relative overflow-hidden">
                    <div className="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-white opacity-10 rounded-full blur-2xl"></div>
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
                        <div>
                            <h2 className="text-3xl font-bold mb-2">Student Leaderboard</h2>
                            <p className="text-indigo-100 opacity-90">See how you rank among your peers.</p>
                        </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-slate-700/50">
                            {leaderboard.map((student, index) => {
                                ...
                                return (
                                    <div key={student.id || index} className={`p-4 sm:px-6 flex items-center transition-colors ${isCurrentUser ? 'bg-indigo-50/50 dark:bg-indigo-900/10' : 'hover:bg-slate-50 dark:hover:bg-slate-700/30'} ${isTop3 ? 'py-5' : 'py-4'}`}>
                                        ...
                                        <div className="ml-4 sm:ml-6 flex-1 flex items-center">
                                            <div className="relative">
                                                {student.profile_image ? (
                                                    ...
                                                    <div className={`rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-indigo-700 dark:text-indigo-400 font-bold border-2 border-white dark:border-slate-800 shadow-sm ${isTop3 ? 'w-14 h-14 text-xl' : 'w-10 h-10 text-lg'}`}>
                                            ...
                                            <div className="ml-4">
                                                <h3 className={`font-bold ${isCurrentUser ? 'text-indigo-700 dark:text-indigo-400' : 'text-slate-900 dark:text-white'} ${isTop3 ? 'text-lg' : 'text-base'}`}>
                                        ...
                                        <div className="ml-4 text-right">
                                            <div className={`font-black ${isTop3 ? 'text-2xl text-indigo-600 dark:text-indigo-400' : 'text-xl text-slate-700 dark:text-slate-300'}`}>
