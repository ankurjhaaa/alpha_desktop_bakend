...
export default function StudentDashboard() {
 ...
 <div className="p-3 rounded-lg bg-primary-light-hover/50 ">
 ...
 <div key={i} className="flex items-center justify-between p-4 rounded-xl border border-primary-light bg-primary-light/50 ">
 <div className="flex items-center">
 ...
 <div className="px-2 py-1 rounded bg-primary-light-hover text-primary-hover text-[10px] font-bold">
 READY
 </div>
 </div>
 ))}
